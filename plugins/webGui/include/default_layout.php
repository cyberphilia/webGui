...
<html>
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="/vendor/normalize/normalize.css">
        <link type="text/css" rel="stylesheet" href="/vendor/jGrowl/jquery.jgrowl.css">
        <link type="text/css" rel="stylesheet" href="/vendor/dropdown-check-list/ui.dropdown.checklist.css">
        <link type="text/css" rel="stylesheet" href="/vendor/shadowbox/shadowbox.css">
        ...
        <script type="text/javascript" src="/vendor/jquery-ui/jquery.ui.custom.js"></script>
        <script type="text/javascript" src="/vendor/dropdown-check-list/ui.dropdown.checklist.js"></script>
        <script type="text/javascript" src="/vendor/shadowbox/shadowbox.js"></script>
        <!--[if lt IE 9]>
